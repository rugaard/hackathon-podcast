<template>
  <section class="pb-10">
    <header class="pb-10 border-b-2">
      <h2 class="text-20 font-semibold text-center">Podcasts</h2>
    </header>
    <div class="grid grid-cols-1 md:grid-cols-3 md:gap-25 md:mt-25 border-b-2 divide-y-2 md:divide-y-0">
      <template v-for="show in shows">
        <RouterLink :to="{ name: 'podcast-show', params: { showId: show.id }}" class="px-20 odd:bg-gray-50">
          <section class="col-span-1 py-20 md:py-0">

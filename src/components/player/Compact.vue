      ...
      <div class="mt-5 px-45 flex flex-col">
        ...
        <div class="my-30 flex items-center justify-between gap-10">
          ...
          <div class="flex-1 flex flex-col items-center justify-center relative">
            <input type="range" class="w-full h-5 accent-pink-300 bg-transparent absolute -top-3 z-1 appearance-none" @change.prevent="(event: Event) => player.position(event.target?.value)" :value="player.timePlayedInPercentage.value || 0" min="0" max="100" />
